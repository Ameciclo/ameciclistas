    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-lg font-semibold">{session.end - session.start}s</div>
            <div className="text-sm text-gray-600">Duração</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded">
            <div className="text-lg font-semibold">
              {new Date(session.start * 1000).toLocaleTimeString('pt-BR')}
            </div>
            <div className="text-sm text-gray-600">Início</div>
          </div>
        </div>

        <h3 className="font-semibold mb-4">Scans de Redes WiFi</h3>
            ...
            <div key={index} className="border rounded-lg p-4">
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="text-sm text-gray-600">
                  Timestamp: {scan.timestamp} | Real Time: {scan.realTime}
                </div>
              </div>
